...
c.JupyterHub.ssl_cert = '/home/xin/src/DotFiles-Linux/jupyterhub/mycert.pem'

## Path to SSL key file for the public facing interface of the proxy
#
#  When setting this, you should also set ssl_cert
c.JupyterHub.ssl_key = '/home/xin/src/DotFiles-Linux/jupyterhub/mykey.key'
...
c.Authenticator.whitelist = set(["xin","test","jupyter","miaoqy","lijx","qinlx","shenwz","majl"])
